//! final-test Shared Library
//!
//! This crate contains shared types, utilities, and common functionality
//! used across the final-test application ecosystem.
//!
//! ## Features
//!
...
//! ```toml
//! [dependencies]
//! final-test-shared = { path = "../final-test-shared" }
//! ```
//!
//! ## Examples
//!
...
//!
//! ```rust
//! use final_test_shared::AppError;
//!
...
/// 
/// This enum defines all possible errors that can occur throughout the final-test
...
///
/// ```rust
/// use final_test_shared::Environment;
/// use std::str::FromStr;
///
/// // Parse from string
...
impl Config {
    ...
    ///
    /// ```rust
    /// use final_test_shared::{Config, Environment};
    ///
...
pub mod models {
    ...
    ///
    /// ```rust
    /// use final_test_shared::models::User;
    /// use uuid::Uuid;
    /// use chrono::Utc;
    ///
    /// let user = User {
    ...
    ///
    /// ```rust
    /// use final_test_shared::models::CreateUserRequest;
    ///
...
pub mod utils {
    ...
    ///
    /// ```rust
    /// use final_test_shared::utils::generate_id;
    ///
    /// let id = generate_id();
    ...
    ///
    /// ```rust
    /// use final_test_shared::utils::slugify;
    ///
