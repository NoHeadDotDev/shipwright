//! installed-test Shared Library
//!
//! This crate contains shared types, utilities, and common functionality
//! used across the installed-test application ecosystem.
//!
//! ## Features
//!
...
//! ```toml
//! [dependencies]
//! installed-test-shared = { path = "../installed-test-shared" }
//! ```
//!
//! ## Examples
//!
...
//!
//! ```rust
//! use installed_test_shared::AppError;
//!
...
/// 
/// This enum defines all possible errors that can occur throughout the installed-test
...
///
/// ```rust
/// use installed_test_shared::Environment;
/// use std::str::FromStr;
///
/// // Parse from string
...
impl Config {
    ...
    ///
    /// ```rust
    /// use installed_test_shared::{Config, Environment};
    ///
...
pub mod models {
    ...
    ///
    /// ```rust
    /// use installed_test_shared::models::User;
    /// use uuid::Uuid;
    /// use chrono::Utc;
    ///
    /// let user = User {
    ...
    ///
    /// ```rust
    /// use installed_test_shared::models::CreateUserRequest;
    ///
...
pub mod utils {
    ...
    ///
    /// ```rust
    /// use installed_test_shared::utils::generate_id;
    ///
    /// let id = generate_id();
    ...
    ///
    /// ```rust
    /// use installed_test_shared::utils::slugify;
    ///
