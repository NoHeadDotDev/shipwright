//! amazing-app Shared Library
//!
//! This crate contains shared types, utilities, and common functionality
//! used across the amazing-app application ecosystem.
//!
//! ## Features
//!
...
//! ```toml
//! [dependencies]
//! amazing-app-shared = { path = "../amazing-app-shared" }
//! ```
//!
//! ## Examples
//!
...
//!
//! ```rust
//! use amazing_app_shared::AppError;
//!
...
/// 
/// This enum defines all possible errors that can occur throughout the amazing-app
...
///
/// ```rust
/// use amazing_app_shared::Environment;
/// use std::str::FromStr;
///
/// // Parse from string
...
impl Config {
    ...
    ///
    /// ```rust
    /// use amazing_app_shared::{Config, Environment};
    ///
...
pub mod models {
    ...
    ///
    /// ```rust
    /// use amazing_app_shared::models::User;
    /// use uuid::Uuid;
    /// use chrono::Utc;
    ///
    /// let user = User {
    ...
    ///
    /// ```rust
    /// use amazing_app_shared::models::CreateUserRequest;
    ///
...
pub mod utils {
    ...
    ///
    /// ```rust
    /// use amazing_app_shared::utils::generate_id;
    ///
    /// let id = generate_id();
    ...
    ///
    /// ```rust
    /// use amazing_app_shared::utils::slugify;
    ///
