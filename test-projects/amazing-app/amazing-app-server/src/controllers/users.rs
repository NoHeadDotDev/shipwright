...
use amazing_app_shared::{AppError, models::{User, CreateUserRequest}};
...
pub async fn create_user(
    ...
    let user_id = amazing_app_shared::utils::generate_id();
    let now = Utc::now();
...
mod tests {
    ...
    async fn test_create_user() {
        ...
        let config = Config {
            ...
            environment: amazing_app_shared::Environment::Development,
        };
