//! hello-world-local Shared Library
//!
//! This crate contains shared types, utilities, and common functionality
//! used across the hello-world-local application ecosystem.
//!
//! ## Features
//!
...
//! ```toml
//! [dependencies]
//! hello-world-local-shared = { path = "../hello-world-local-shared" }
//! ```
//!
//! ## Examples
//!
...
//!
//! ```rust
//! use hello_world_local_shared::Config;
//!
...
//!
//! ```rust
//! use hello_world_local_shared::AppError;
//!
...
/// 
/// This enum defines all possible errors that can occur throughout the hello-world-local
...
///
/// ```rust
/// use hello_world_local_shared::Environment;
/// use std::str::FromStr;
///
/// // Parse from string
...
impl Config {
    ...
    pub fn from_env() -> Result<Self, AppError> {
        ...
        Ok(Config {
            name: "hello-world-local".to_string(),
            port,
            host,
            environment,
        })
    ...
    ///
    /// ```rust
    /// use hello_world_local_shared::{Config, Environment};
    ///
...
pub mod models {
    ...
    ///
    /// ```rust
    /// use hello_world_local_shared::models::User;
    /// use uuid::Uuid;
    /// use chrono::Utc;
    ///
    /// let user = User {
    ...
    ///
    /// ```rust
    /// use hello_world_local_shared::models::CreateUserRequest;
    ///
...
pub mod utils {
    ...
    ///
    /// ```rust
    /// use hello_world_local_shared::utils::generate_id;
    ///
    /// let id = generate_id();
    ...
    ///
    /// ```rust
    /// use hello_world_local_shared::utils::slugify;
    ///
