...
use yeah_ship_shared::{AppError, models::{User, CreateUserRequest}};
...
pub async fn create_user(
    ...
    let user_id = yeah_ship_shared::utils::generate_id();
    let now = Utc::now();
...
mod tests {
    ...
    async fn test_create_user() {
        ...
        let config = Config {
            ...
            environment: yeah_ship_shared::Environment::Development,
        };
