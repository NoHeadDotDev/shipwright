...
//!
//! shipwright-liveview allows you to build rich, real-time experiences with server-rendered HTML. This
...
//!     let app = Router::new()
//!         .route("/", get(root))
//!         // Use a precompiled and minified build of shipwright-liveview's JavaScript.
//!         // This is the easiest way to get started. Integration with bundlers
//!         // is of course also possible.
//!         .route("/assets/live-view.js", shipwright_liveview::precompiled_js());
//!
//!     # async {
...
/// A precompiled build of shipwright-liveview's JavaScript.
///
/// This enables using shipwright-liveview without a bundler like [webpack].
///
/// What's compiled is
///
/// ```javascript
/// import { LiveView } from "shipwright-liveview"
///
...
/// A route that returns a precompiled build of shipwright-liveview's JavaScript.
///
/// This enables using shipwright-liveview without a bundler like [webpack].
///
/// What's compiled is
...
/// ```
/// use axum::Router;
/// use shipwright_liveview::precompiled_js;
///
