//! Internal macro crate for [shipwright-liveview].
//!
//! [shipwright-liveview]: https://crates.io/crates/shipwright-liveview
    ...
    T: NodeToTokens,
{
    fn to_tokens(&self, out: &mut TokenStream) {
        ...
        inside_braces.extend(quote! {
            let mut __dynamic = std::vec::Vec::<shipwright_liveview::__private::DynamicFragment<_>>::new();
        });
        ...
        out.extend(quote! {
            {
                use shipwright_liveview::__private::DynamicFragmentVecExt;
                #inside_braces
                shipwright_liveview::__private::HtmlBuilder {
                    dynamic: __dynamic,
                    fixed: &[#(#parts),*],
                }.into_html()
            }
